...
export type BuildResourcesRoutes<options extends ResourcesOptions, method extends ResourcesMethod, param extends string> = {
    [methodName in method as GetResourcesRouteName<options, methodName>]: ResourcesRoutes<param>[methodName];
};
export type GetResourcesRouteName<options extends ResourcesOptions, method extends ResourcesMethod> = method extends ResourcesMethod ? options extends {
    names: {
...
export type GetParam<options extends ResourcesOptions> = options extends {
